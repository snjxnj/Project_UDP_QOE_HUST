...
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "BiLSTM")
...
class LSTMModel:
    ...
    def build_model(self):
        ...
        # 添加双向LSTM层
        self.model.add(Bidirectional(LSTM(128, return_sequences=True), input_shape=(self.sequence_length, len(self.feature_columns))))
    ...
    def save_model(self, model_path='lstm_model.h5'):
        ...
        self.model.save(os.path.join(OUTPUT_DIR, model_path))
