...
rem 2026.3.9：运行py脚本后对其控制台输出内容进行提取得到csv路径
echo 正在运行数据预处理脚本...
...
:process_cap_file
    ...
    if "!command_mode!"=="ipv6" (
        ...
        if "!ip_Format_Local!"=="ipv6" if "!ip_Format_Serv!"=="ipv6" (
            tshark -r "!cap_file!" -Y "udp and (ipv6.src == !local_ip!) and (ipv6.dst == !serv_ip!)" -T fields -E header=y -E separator=, -E quote=d -e frame.time_epoch -e ipv6.src -e ipv6.dst -e frame.protocols -e frame.len > "!output_dir!\!cap_filename!_IPv6_send_!num!.csv"
            tshark -r "!cap_file!" -Y "udp and (ipv6.src == !serv_ip!) and (ipv6.dst == !local_ip!)" -T fields -E header=y -E separator=, -E quote=d -e frame.time_epoch -e ipv6.src -e ipv6.dst -e frame.protocols -e frame.len > "!output_dir!\!cap_filename!_IPv6_recv_!num!.csv"
        ) else if "!ip_Format_Local!"=="ipv6" if "!ip_Format_Serv!"=="any" (
            tshark -r "!cap_file!" -Y "udp and (ipv6.src == !local_ip!)" -T fields -E header=y -E separator=, -E quote=d -e frame.time_epoch -e ipv6.src -e ipv6.dst -e frame.protocols -e frame.len > "!output_dir!\!cap_filename!_IPv6_send_!num!.csv"
            tshark -r "!cap_file!" -Y "udp and (ipv6.dst == !local_ip!)" -T fields -E header=y -E separator=, -E quote=d -e frame.time_epoch -e ipv6.src -e ipv6.dst -e frame.protocols -e frame.len > "!output_dir!\!cap_filename!_IPv6_recv_!num!.csv"
        ) else if "!ip_Format_Local!"=="any" if "!ip_Format_Serv!"=="ipv6" (
            tshark -r "!cap_file!" -Y "udp and (ipv6.dst == !serv_ip!)" -T fields -E header=y -E separator=, -E quote=d -e frame.time_epoch -e ipv6.src -e ipv6.dst -e frame.protocols -e frame.len > "!output_dir!\!cap_filename!_IPv6_send_!num!.csv"
            tshark -r "!cap_file!" -Y "udp and (ipv6.src == !serv_ip!)" -T fields -E header=y -E separator=, -E quote=d -e frame.time_epoch -e ipv6.src -e ipv6.dst -e frame.protocols -e frame.len > "!output_dir!\!cap_filename!_IPv6_recv_!num!.csv"
        )
        ...
        if "!ip_Format_Local!"=="ipv4" if "!ip_Format_Serv!"=="ipv4" (
            tshark -r "!cap_file!" -Y "udp and (ip.src == !local_ip!) and (ip.dst == !serv_ip!)" -T fields -E header=y -E separator=, -E quote=d -e frame.time_epoch -e ip.src -e ip.dst -e frame.protocols -e frame.len > "!output_dir!\!cap_filename!_IPv4_send_!num!.csv"    
            tshark -r "!cap_file!" -Y "udp and (ip.src == !serv_ip!) and (ip.dst == !local_ip!)" -T fields -E header=y -E separator=, -E quote=d -e frame.time_epoch -e ip.src -e ip.dst -e frame.protocols -e frame.len > "!output_dir!\!cap_filename!_IPv4_recv_!num!.csv"
        ) else if "!ip_Format_Local!"=="ipv4" if "!ip_Format_Serv!"=="any" (
            tshark -r "!cap_file!" -Y "udp and (ip.src == !local_ip!)" -T fields -E header=y -E separator=, -E quote=d -e frame.time_epoch -e ip.src -e ip.dst -e frame.protocols -e frame.len > "!output_dir!\!cap_filename!_IPv4_send_!num!.csv"
            tshark -r "!cap_file!" -Y "udp and (ip.dst == !local_ip!)" -T fields -E header=y -E separator=, -E quote=d -e frame.time_epoch -e ip.src -e ip.dst -e frame.protocols -e frame.len > "!output_dir!\!cap_filename!_IPv4_recv_!num!.csv"
        ) else if "!ip_Format_Local!"=="any" if "!ip_Format_Serv!"=="ipv4" (
            tshark -r "!cap_file!" -Y "udp and (ip.dst == !serv_ip!)" -T fields -E header=y -E separator=, -E quote=d -e frame.time_epoch -e ip.src -e ip.dst -e frame.protocols -e frame.len > "!output_dir!\!cap_filename!_IPv4_send_!num!.csv"   
            tshark -r "!cap_file!" -Y "udp and (ip.src == !serv_ip!)" -T fields -E header=y -E separator=, -E quote=d -e frame.time_epoch -e ip.src -e ip.dst -e frame.protocols -e frame.len > "!output_dir!\!cap_filename!_IPv4_recv_!num!.csv"   
        )
    )
